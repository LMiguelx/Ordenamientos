...
# Definición del algoritmo de Ordenamiento Burbuja
...
# Redefinición de Ordenamiento Burbuja (esto estaba definido dos veces, la segunda definición sobrescribe la primera)
...
# Algoritmos de ordenamiento para probar
Ordenamientos = [bucket_sort, bubble_sort]
...
plt.title('Tiempo de ejecución de Bucket sort y Bubble Sort')
